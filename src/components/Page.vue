...
export default class Page extends Vue {
  ...
  @Prop() readonly blur?: string = "blur(2px)";
  @Prop() readonly grayscale?: string = "grayscale(100%)";
  ...
  get rootStyles() {
    return {
      ...
      filter: this.blur && this.grayscale && this.background && this.inverted ? `contrast(140%)` : null,
